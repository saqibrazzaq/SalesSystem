...
function AvailabilityDelete() {
  ...
  const [availability, setAvailability] = useState({ id: "", name: "" });
  ...
  return (
    <>
      <Typography variant="h6">Delete Availability</Typography>
      ...
      <form onSubmit={handleSubmit}>
        <Box sx={{ mt: 2 }}>
          ...
          <Typography variant="h4">{availability.name}</Typography>
        </Box>

        <Box sx={{ mt: 2 }}>
          <Button color="error" variant="contained" type="submit">
            YES, I WANT TO DELETE THE AVAILABILITY
          </Button>
          <Button
            component={Link}
            to={mainUrl}
